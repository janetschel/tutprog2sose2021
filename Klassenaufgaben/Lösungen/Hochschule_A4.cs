...
namespace ConsoleApp2
{
    public class Hochschule
    {
        ...
        // Aufgabe 4
        public static bool operator ==(Hochschule first, Hochschule second)
        {
            return first.durchschnittlicherNotendurchschnitt() == second.durchschnittlicherNotendurchschnitt();
        }
        
        // wenn == überladen ist, muss auch != überladen sein!
        public static bool operator !=(Hochschule first, Hochschule second)
        {
            return !(first == second); // wir benutzen hier den == Operator und kehren das Ergebnis um
        }
    }
}